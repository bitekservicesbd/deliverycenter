...
export default function LoadCreate() {
    ...
    const [distance_unit, setDistanceUnit] = React.useState('KM');
    const [veShowDT, setVeShowDT] = React.useState(false);
                  ...
                  <div className="flex flex-wrap items-center justify-between">
                    ...
                    <div className="mt-3 flex gap-3">
                      <div className="flex gap-1">
                        <Checkbox />
                        <Label htmlFor="dispatch_hold">Dispatch Hold</Label>
                      </div>
                      <div className="flex gap-1">
                        <Checkbox />
                        <Label htmlFor="finalize_hold">Finalize Hold</Label>
                      </div>
                      <div className="flex gap-1">
                        <Checkbox />
                        <Label htmlFor="settlement_hold">Settlement Hold</Label>
                      </div>
                    </div>
                  </div>
                  ...
                  <Tabs defaultValue="load_info" className="mt-3">
                    <PageNav>
                      <TabsList>
                        ...
                        <TabsTrigger value="VENDOR_EXPANSE">
                          VENDOR EXPANSE
                        </TabsTrigger>
                              ...
                              <div className="mx-3">
                                ...
                                <div className="mt-3">
                                  <div className="flex flex-col">
                                    ...
                                    {/* <Input type="datetime-local" id="date-picker" /> */}
                                    <Popover
                                      open={DispatchedDateOpen}
                                      onOpenChange={setDispatchedDateOpen}
                                    >
                                      <div className="flex">
                                        <PopoverTrigger asChild>
                                          <Button
                                ...
                                <div className="mt-3">
                                  <Label htmlFor="carrier_payment_amount">
                                ...
                                <div className="mt-3">
                                  <div className="flex flex-col">
                                    ...
                                    {/* <Input type="datetime-local" id="date-picker" /> */}
                                    <Popover
                                      open={CancelledDateOpen}
                                      onOpenChange={setCancelledDateOpen}
                                    >
                                      <div className="flex">
                                        <PopoverTrigger asChild>
                                          <Button
                                ...
                                <div className="mt-3 flex flex-wrap items-center gap-3">
                                  <div className="">
                                    ...
                                    >
                                      ...
                                      <SelectContent>
                                        <SelectItem value="5 Tons">
                                          5 Tons
                                        </SelectItem>
                                        <SelectItem value="10 Tons">
                                          10 Tons
                                        </SelectItem>
                                      </SelectContent>
                                    </Select>
                                ...
                                <div className="mt-3 bg-slate-50 px-4 pt-1 pb-5 dark:bg-zinc-950">
                                  <Tabs defaultValue="PACKAGES">
                                    <div>
                                      <PageNav>
                                        <TabsList>
                                          ...
                                          <TabsTrigger value="CHILD_LOADS">
                                            CHILD LOADS
                                          </TabsTrigger>
                                          <TabsTrigger value="CUSTOM_FIELDS">
                                            CUSTOM FIELDS
                                          </TabsTrigger>
                                        </TabsList>
                                      </PageNav>
                                    ...
                                    <TabsContent value="CHILD_LOADS">
                                      <div className="w-full overflow-x-auto rounded-lg border border-gray-300 pb-10 shadow-md">
                                        <table className="min-w-full text-left text-sm rtl:text-right">
                                          <thead className="custom-nav-color">
                                            <tr>
                    ...
                    <TabsContent value="VENDOR_EXPANSE">
                      <div>
                        <table className="w-full">
                          <thead className="w-full bg-slate-100 dark:bg-zinc-800">
                            <tr>
                              <th className="py-2">
                                {" "}
                                <Button
                                  type="button"
                                  onClick={() => setVeShowDT(true)}
                                  size="sm"
                                  variant={"outline"}
                                >
                                  {" "}
                              ...
                              <th className="py-2">Change Type</th>
                          ...
                          <tbody>
                            {!veShowDT && (
                              <tr>
                                <td
                                  colSpan={5}
                                  className="border-s border-e border-b py-10 text-center"
                                >
                                  No Data
                                </td>
                              </tr>
                              ...
                              <tr className="border">
                                ...
                                <td className="px-3 py-5">
                                  <Select>
                                    <SelectTrigger
                                      className="w-full"
                                      defaultValue="Sales commission"
                                    >
                                      <SelectValue placeholder="Sales commission" />
                                    </SelectTrigger>
                                    <SelectContent>
                                      <SelectItem value="Sales commission">
                                        Sales commission
                                      </SelectItem>
                                    </SelectContent>
                                  </Select>
                                ...
                                <td className="px-3 py-5">
                                  <Select>
                                    ...
                                    <SelectContent>
                                      <SelectItem value="Canadian Dollar">
                                        Canadian Dollar
                                      </SelectItem>
                                      <SelectItem value="United States Dollar">
                    ...
                    <TabsContent value="AUDIT">
                      <div>
                        <table className="w-full">
                          <thead className="w-full bg-slate-100 dark:bg-zinc-800">
                            <tr>
                              <th className="py-2 ps-2 text-start">Amount</th>
                              <th className="py-2 ps-2 text-start">User</th>
                              <th className="py-2 ps-2 text-start">Change</th>
                            </tr>
                          </thead>
                          <tbody>
                            <tr>
