  ...
  return (
    <div>
      ...
      <PageNav className="mb-4 py-1">
        <span className="ms-5 font-bold text-white">
          Invoicing Finalizing Loads
        </span>
      </PageNav>
                  ...
                  <div className="mx-5">
                    <div className="w-full">
                      <div className="flex w-full items-center gap-2 pt-3">
                        <Label className="w-1/3 whitespace-nowrap">
                          Load Status:
                        </Label>
                    ...
                    <div className="w-full">
                      <div className="flex w-full items-center gap-2 pt-3">
                        ...
                        <Select>
                          ...
                          <SelectContent>
                            <SelectGroup>
                              <SelectItem value="Bitech Services">
                                Bitech Services
                              </SelectItem>
                              <SelectItem value="open">Open</SelectItem>
                              <SelectItem value="close">Close</SelectItem>
      ...
      <Tabs defaultValue="change-status">
        ...
        <Table>
          <TableHeader className="custom-nav-color">
            <TableRow>
              <TableHead className="border-r border-white px-1 py-2 text-white">
                Edit
              </TableHead>
              <TableHead className="border-r border-white px-1 py-2 text-white">
                Invoice
          ...
          <TableBody>
            <TableRow>
              <TableCell
                colSpan={18}
                className="border py-14 text-center font-bold"
              >
                No Data
              </TableCell>
            </TableRow>
