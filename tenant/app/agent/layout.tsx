...
import { TenantSidebar } from "@/components/agent/client/app-sidebar";
...
export const metadata: Metadata = {
  title: {
    template: "%s | Delivery Center Agent",
    default: "Delivery Center Agent",
  },
  description: "Delivery Center Agent Application",
};
