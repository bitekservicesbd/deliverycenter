...
export default function CreateCarrier() {
    ...
    return (
        <div>
            <TopSearch />
            <PageNav className="mt-3 mb-2 py-2">
                        ...
                        <div className="overflow-y-scroll border pb-32">
                            <Table className="w-full">
                                ...
                                <TableRow>
                                    ...
                                    <TableHead className="py-2">Fax</TableHead>
                                    <TableHead className="py-2">Mobile</TableHead>
                                    <TableHead className="py-2 pe-2">Active</TableHead>
                                </TableRow>
                                </TableHeader>
                                <TableBody>
                                <TableRow>
                                    <TableCell colSpan={7} className="border-b py-2 text-center">
                                        No data to display
                                    </TableCell>
                                </TableRow>
                                </TableBody>
                                    ...
                                    <div className="overflow-y-scroll border pb-32">
                                        <Table className="w-full">
                                            ...
                                            <TableRow>
                                                ...
                                                <TableHead className="py-2">Dispatch Zone</TableHead>
                                            </TableRow>
                                            </TableHeader>
                                            <TableBody>
                                            <TableRow className={`border ${pickupAddOpen ? '' : 'hidden'}`}>
                                            ...
                                            <TableRow className={pickupAddOpen == false ? '' : 'hidden'}>
                                                <TableCell colSpan={2} className="border-b py-2 text-center">
                                                    No data to display
                                                </TableCell>
                                            </TableRow>
                                            </TableBody>
                                ...
                                <div>
                                    <div className="overflow-y-scroll border pb-32">
                                        <Table className="w-full">
                                            ...
                                            <TableBody>
                                            <TableRow className={`border ${DeliveryAddOpen ? '' : 'hidden'}`}>
                                                <TableCell className="text-center">
                                            ...
                                            <TableRow className={DeliveryAddOpen == false ? '' : 'hidden'}>
                                                <TableCell colSpan={2} className="border-b py-2 text-center">
                                                    No data to display
                                                </TableCell>
                                            </TableRow>
                                    ...
                                    <div className="overflow-y-scroll border pb-32">
                                        <Table className="w-full">
                                            ...
                                            <TableRow>
                                                ...
                                                <TableHead className="py-2">Carrier Payment Zone</TableHead>
                                                <TableHead className="py-2">Daily Guarantee Amount</TableHead>
                                            </TableRow>
                                            </TableHeader>
                                            <TableBody>
                                            <TableRow className={`border ${GuaranteedOpen ? '' : 'hidden'}`}>
                                                <TableCell className="mx-1 text-center">
                                                    <Button onClick={() => setGuaranteedOpen(false)}>
                                                        <Undo2 />
                                                    </Button>
                                                </TableCell>
                                                <TableCell className="mx-1 py-2 text-center">
                                                    <Select>
                                                        <SelectTrigger className="w-full">
                                                            <SelectValue />
                                                        </SelectTrigger>
                                                ...
                                                <TableCell className="mx-1">
                                                    <Input type="text" className="w-full" />
                                                </TableCell>
                                            </TableRow>
                                            <TableRow className={GuaranteedOpen == false ? '' : 'hidden'}>
                                                <TableCell colSpan={3} className="border-b py-2 text-center">
                                                    No data to display
                                                </TableCell>
                                            </TableRow>
                                            </TableBody>
                                ...
                                <div>
                                    ...
                                    <div className="overflow-y-scroll border pb-32">
                                        <Table className="w-full">
                                            ...
                                            <TableBody>
                                            <TableRow className={`border ${BannedCustomerOpen ? '' : 'hidden'}`}>
                                                <TableCell className="mx-1 text-center">
                                            ...
                                            <TableRow className={BannedCustomerOpen == false ? '' : 'hidden'}>
                                                <TableCell colSpan={2} className="border-b py-2 text-center">
                                                    No data to display
                                                </TableCell>
                                            </TableRow>
                    ...
                    <TabsContent value="Settlements">
                        <div className="overflow-y-scroll border pb-32">
                            ...
                            <Table className="w-full">
                                <TableHeader className="custom-nav-color text-white">
                                <TableRow>
                                    <TableHead className="py-2 ps-2">Select</TableHead>
                                    <TableHead className="py-2">Number</TableHead>
                                    <TableHead className="py-2">Batch Number</TableHead>
                                    <TableHead className="py-2">Amount</TableHead>
                                    <TableHead className="py-2">Tax Amount</TableHead>
                                    <TableHead className="py-2">Total Amount</TableHead>
                                    <TableHead className="py-2 pe-2">Memo</TableHead>
                                </TableRow>
                                </TableHeader>
                                <TableBody>
                                <TableRow>
                        ...
                        <div>
                            <div className="overflow-y-scroll border pb-32">
                                <Table className="w-full">
                                    <TableHeader className="custom-nav-color text-white">
                                    <TableRow>
                                        <TableHead className="py-2 ps-2">Action</TableHead>
                                    ...
                                    <TableBody>
                                    <TableRow>
                                        <TableCell colSpan={5} className="border-b py-2 text-center">
                                            No data to display
                                        </TableCell>
                                    </TableRow>
                                    </TableBody>
                        ...
                        <div className="overflow-y-scroll border pb-32">
                            ...
                            <Table className="w-full">
                                ...
                                <TableRow>
                                    ...
                                    <TableHead className="py-2">API Type</TableHead>
                                    <TableHead className="py-2">URL Endpoint</TableHead>
                                </TableRow>
                                </TableHeader>
                                <TableBody>
                                <TableRow>
                        ...
                        <div className="overflow-y-scroll border pb-32">
                            <Table className="w-full">
                                ...
                                <TableRow>
                                    ...
                                    <TableHead className="py-2">Enabled</TableHead>
                                    <TableHead className="py-2">Start Date</TableHead>
                                    <TableHead className="py-2">End Date</TableHead>
                                    <TableHead className="py-2">Amount</TableHead>
                                    <TableHead className="py-2">Percentage of Gross Per Frequency</TableHead>
                                    <TableHead className="py-2 pe-2">Paid Off</TableHead>
                                </TableRow>
                                </TableHeader>
                                <TableBody>
                                <TableRow>
                                    <TableCell colSpan={8} className="border-b py-2 text-center">
                                        No data to display
                                    </TableCell>
                                </TableRow>
                                </TableBody>
                        ...
                        <div className="overflow-y-scroll border pb-32">
                            <Table className="w-full">
                                ...
                                <TableRow>
                                    ...
                                    <TableHead className="py-2">Note Type</TableHead>
                                    <TableHead className="py-2">User Name</TableHead>
                                </TableRow>
                                </TableHeader>
                                <TableBody>
                                <TableRow>
