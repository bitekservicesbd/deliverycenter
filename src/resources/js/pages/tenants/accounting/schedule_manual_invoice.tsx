                            ...
                            <Table className="w-full">
                                <TableHeader className="w-full">
                                    <TableRow>
                                        ...
                                        <TableHead className="custom-nav-color border-r px-1 py-2 text-white">Enabled</TableHead>
                                    </TableRow>
                                </TableHeader>
                                <TableBody>
                                    <TableRow>
                                        <TableCell colSpan={6} className="border-b py-5 text-center">
                                            No data to display
                                        </TableCell>
                                    </TableRow>
                                </TableBody>
                    ...
                    <Tabs defaultValue="Manual-Invoice">
                        ...
                        <div>
                                        ...
                                        <Table className="w-full">
                                            <TableHeader className="w-full">
                                                <TableRow>
                                                    ...
                                                    <TableHead className="custom-nav-color border-r px-1 py-2 text-white">Description</TableHead>
                                                    <TableHead className="custom-nav-color border-r px-1 py-2 text-white">Qty</TableHead>
                                                    <TableHead className="custom-nav-color border-r px-1 py-2 text-white">Client Rate</TableHead>
                                                    <TableHead className="custom-nav-color border-r px-1 py-2 text-white">Client Amount</TableHead>
                                                    <TableHead className="custom-nav-color border-r px-1 py-2 text-white">Fed Tax</TableHead>
                                                    <TableHead className="custom-nav-color border-r px-1 py-2 text-white">State/Prov Tax</TableHead>
                                                    <TableHead className="custom-nav-color border-r px-1 py-2 text-white">GL Code</TableHead>
                                                </TableRow>
                                            </TableHeader>
                                            <TableBody>
                                                <TableRow>
                            ...
                            <TabsContent value="Schedule-Settings">
                                <div className="border p-4">
                                    <p className="mb-4">Please specify the period during which the schedule will execute</p>
                                    ...
                                    <div className="mb-4 flex gap-4">
                                        ...
                                        <div className="mt-2 space-y-4">
                                            <div className="flex items-center gap-2">
                                                <Checkbox className="h-4 w-4" id="schedule_range_enabled" />
                                            ...
                                            <p className="text-sm text-gray-600">
                                                (All settings will work in reference to the start date to create the manual invoice)
                                            </p>

                                            <div className="space-y-3">
                                                <div className="flex items-center gap-2">
                                                    <input type="radio" name="endOption" id="no_end_date" />
                                                    ...
                                                    <Popover open={endByOpen} onOpenChange={setEndByOpen}>
                                                        <PopoverTrigger asChild>
                                                            <Button
                                                                ...
                                                                className="min-w-[180px] justify-start text-left font-normal dark:border-gray-700 dark:text-gray-200"
                                                            >
                                                                {endBy ? endBy.toLocaleDateString() : <span>End by</span>}
                                                                <ChevronDownIcon className="ml-auto h-4 w-4 opacity-50" />
                                                            </Button>
                                                        </PopoverTrigger>
                                                        <PopoverContent className="w-auto p-0 dark:bg-gray-800 dark:text-gray-200" align="end">
                                        ...
                                        <div className="flex flex-wrap items-center gap-4">
                                            {['daily', 'weekly', 'monthly', 'yearly'].map((type) => (
                                                <div key={type} className="flex items-center gap-1">
                                                    <input type="radio" name="scheduleType" id={`schedule_type_${type}`} />
                                                    <Label htmlFor={`schedule_type_${type}`}>{type.charAt(0).toUpperCase() + type.slice(1)}</Label>
                                                </div>
                                            ))}
                                        </div>
                                    </div>
                                    ...
                                    <div className="mb-4 flex gap-4">
                                        <div>
                                            <h5 className="text-lg font-semibold">Weekly Settings:</h5>
                                        </div>
                                        <div className="space-y-3">
                                            <div className="flex flex-wrap items-center gap-2">
                                            ...
                                            <div className="flex flex-wrap gap-4">
                                                {['sunday', 'monday', 'tuesday', 'wednesday', 'thursday', 'friday', 'saturday'].map((day) => (
                                                    <div key={day} className="flex items-center gap-1">
                                                        ...
                                                        <Label htmlFor={day}>{day.slice(0, 3).toUpperCase()}</Label>
                                                    </div>
                                                ))}
                                            </div>
                                        </div>
                                    ...
                                    <div className="mb-4 flex gap-4">
                                        <div>
                                            <h5 className="text-lg font-semibold">Monthly Settings:</h5>
                                        </div>
                                        <div className="space-y-3">
                                            <div className="flex flex-wrap items-center gap-2">
                                                <input type="radio" name="monthlyType" id="day" className="h-4 w-4" />
                                            ...
                                            <div className="flex flex-wrap items-center gap-2">
                                                <input type="radio" name="monthlyType" id="the" className="h-4 w-4" />
                                                ...
                                                <Select>
                                                    ...
                                                    <SelectContent>
                                                        {['first', 'second', 'third', 'fourth', 'last'].map((val) => (
                                    ...
                                    <div className="mb-4 flex gap-4">
                                        <div>
                                            <h5 className="text-lg font-semibold">Yearly Settings:</h5>
                                        </div>
                                        <div className="space-y-3">
                                            <div className="flex flex-wrap items-center gap-2">
                                                <input type="radio" name="yearlyType" id="every" className="h-4 w-4" />
                                            ...
                                            <div className="flex flex-wrap items-center gap-2">
                                                <input type="radio" name="yearlyType" id="yearly_the" className="h-4 w-4" />
