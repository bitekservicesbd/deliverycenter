...
export default function CreateDocks() {
    ...
    return (
        <TenantLayout>
            <Head title="Create Dock" />
            <div className="mb-2">
                <TopSearch />
            </div>
            <PageNav>
                <span className="ms-5 font-bold text-white">Create Dock</span>
            </PageNav>
            <div className="p-4">
                <div className="mb-4 flex justify-end">
                    <Button variant="outline" asChild>
                        <Link href={route('tenant.application.settings.docks')} className="inline-flex items-center">
