...
export default function DataTable() {
    return (
        <TenantLayout>
            <Head title="Customer Type Create" />
            <div>
                <TopSearch className="mb-2" />
                <div className="mb-2">
                    <PageNav>
                        <p className="ps-3 text-white">Customer Type Create</p>
                    </PageNav>
                </div>
                <div className="mx-2">
                        ...
                        <Card className="m-3 w-full md:w-1/4">
                            <CardContent>
                                <div className="grid p-3">
                                    ...
                                    <div className="mt-5 grid">
                                        <Label htmlFor="GLAccount" className="ms-2 mb-2">
                                            GL Account
                                        </Label>
                                        <Input id="GLAccount" placeholder="GL Account" />
                                    </div>
                                    <div className="mt-5 grid">
                                        <Label htmlFor="GLCode" className="ms-2 mb-2">
                                            GL Code
                                        </Label>
                                        <Input id="GLCode" placeholder="GL Code" />
                                    </div>
                                    <div className="mt-5 grid">
