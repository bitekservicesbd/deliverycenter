...
export default function CreatePaymentTypes() {
    ...
    return (
        <TenantLayout>
            <Head title="Create Payment Types" />
            <div className="mb-2">
                <TopSearch />
            </div>
            <PageNav>
                <span className="ms-5 font-bold text-white">Create Payment Types</span>
            </PageNav>
            <div className="p-4">
                <div className="mb-4 flex justify-end">
                    <Button variant="outline" asChild>
                        <Link href={route('tenant.application.settings.payment.types')} className="inline-flex items-center">
