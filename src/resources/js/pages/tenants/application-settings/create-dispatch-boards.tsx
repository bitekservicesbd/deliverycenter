...
export default function CreateDispatchBoards() {
    ...
    return (
        <TenantLayout>
            <Head title="Create Dispatch Board" />
            <div className="mb-2">
                <TopSearch />
            </div>
            <PageNav>
                <span className="ms-5 font-bold text-white">Create Dispatch Board</span>
            </PageNav>
            <div className="p-4">
                <div className="mb-4 flex justify-end">
                    <Button variant="outline" asChild>
                        <Link href={route('tenant.application.settings.dispatch.boards')} className="inline-flex items-center">
                ...
                <div className="rounded border p-4">
                    <div className="mb-8 grid grid-cols-2 gap-4">
                        <div>
                            <Label>Dispatch board Name</Label>
                            <Input />
                        </div>
                        <div>
