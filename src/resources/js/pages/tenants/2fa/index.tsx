...
export default function Index({ qrCodeSvg, secret, errors }) {
    ...
    return (
        <TenantLayout>
            ...
            <div className="max-w-xl space-y-8 px-8 py-4">
                <HeadingSmall
                    ...
                    <div className="space-y-4 rounded-xl border border-slate-200 bg-white p-8 shadow-sm dark:border-slate-700 dark:bg-black">
                        ...
                        <form onSubmit={handleEnable} className="space-y-6">
                            <div>
                                ...
                                <Input id="otp" name="otp" type="text" value={data.otp} onChange={(e) => setData('otp', e.target.value)} required />
                ...
                {enabled && (
                    <div className="space-y-4 rounded-xl border border-slate-200 bg-white p-8 shadow-sm dark:border-slate-700 dark:bg-black">
                        <p>
                            Please enter the <strong>OTP</strong> generated on your Authenticator App. Ensure you submit the current one because it
                        ...
                        <form onSubmit={handleDisable} className="space-y-6">
                            ...
                            <div className="flex items-center justify-end gap-4">
                                ...
                                <Button
                                    type="submit"
                                    disabled={processing}
                                    className="flex items-center gap-2 bg-rose-400 hover:bg-rose-500 dark:text-white"
                                >
                                    <RefreshCcw className={`h-4 w-4 ${processing ? 'animate-spin' : ''}`} />
