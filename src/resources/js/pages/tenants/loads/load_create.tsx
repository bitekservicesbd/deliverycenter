                                        ...
                                        <div className="mt-3 flex flex-wrap gap-2 md:mt-0">
                                            <TopDropdownButton
                                                ...
                                                dropdownItems={[
                                                    ...
                                                    { label: 'Save & Print', onClick: () => console.log('Save & Print') },
                                                    { label: 'Save & Exit', onClick: () => console.log('Save & Exit') },
                                                ]}
                                            />
                                            ...
                                            <TopButton icon={Share2} label="Send CC" onClick={() => {}} />
                                            <TopButton icon={Eye} label="View CC" onClick={() => {}} />
                                            <TopButton icon={RotateCcw} label="Resend" onClick={() => {}} />
                                            <TopButton icon={CalendarDays} label="Schedule" onClick={() => {}} />
                                    ...
                                    <Tabs defaultValue="load_info" className="mt-3">
                                        <PageNav>
                                            <TabsList>
                                                ...
                                                <TabsTrigger value="VENDOR_EXPANSE">VENDOR EXPANSE</TabsTrigger>
                                                                        ...
                                                                        <div>
                                                                            <PageNav>
                                                                                <TabsList>
                                                                                    ...
                                                                                    <TabsTrigger value="CHILD_LOADS">CHILD LOADS</TabsTrigger>
                                                ...
                                                <table className="w-full">
                                                    <thead className="w-full bg-slate-100 dark:bg-zinc-800">
                                                        <tr>
                                                            <th className="py-2">
                                                                {' '}
                                                                <Button type="button" onClick={() => setVeShowDT(true)} size="sm" variant={'outline'}>
                                                                    {' '}
                                                                    <Plus />{' '}
                                                                </Button>{' '}
                                                            </th>
                                                    ...
                                                    <tbody>
                                                        {!veShowDT && (
                                                            <tr>
                                                                <td colSpan={5} className="border-s border-e border-b py-10 text-center">
                                                                    No Data
                                                                </td>
                                                            </tr>
                                                        )}
                                                        {veShowDT && (
                                                            <tr className="border">
                                                                ...
                                                                <td className="px-3 py-5">
                                                                    <Select>
                                                                        <SelectTrigger className="w-full" defaultValue="Sales commission">
                                                                ...
                                                                <td className="px-3 py-5">
                                                                    <Select>
                                                                        <SelectTrigger className="w-full" defaultValue="Vendor">
                                        ...
                                        <TabsContent value="FILES">
                                            <div>
                                                <table className="w-full">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td colSpan={4} className="border-s border-e border-b py-10 text-center">
                                                                No Data
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                        ...
                                        <TabsContent value="AUDIT">
                                            <div>
                                                <table className="w-full">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td className="border px-2 py-3">08/06/2025 01:58</td>
                                                            <td className="border px-2 py-3">Nology Support</td>
                                                            <td className="border px-2 py-3">Exited Edit Mode</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
