    ...
    return (
        <CentralLayout>
            <div className="min-h-screen overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100 text-gray-900">
                ...
                {/* Hero Section */}
                <section className="relative z-10 bg-white py-20 shadow-sm dark:bg-gray-900">
                    <div className="container mx-auto px-6">
                        ...
                        >
                            <div className="mb-4">
                                <span className="font-semibold text-blue-600 dark:text-blue-400">DeliveryCenter's</span>
                            </div>
                            <h1 className="mb-6 text-4xl font-bold text-gray-900 md:text-6xl dark:text-white">Features</h1>
                ...
                <section className="relative z-10 bg-white py-16 dark:bg-gray-900">
                    <div className="container mx-auto px-6">
                        <div
                            className={`mb-12 text-center transition-all delay-700 duration-1000 ${
                                isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
                            }`}
                        >
                            <h2 className="mb-2 text-sm text-gray-500 dark:text-gray-400">Discover the Power of Our</h2>
                            <h3 className="mb-8 text-3xl font-bold text-gray-900 md:text-4xl dark:text-white">Top Software Features</h3>
                        </div>

                        {/* TMS Features */}
                        <div className="mb-16">
                            <h4 className="mb-8 text-2xl font-bold text-blue-600 dark:text-blue-400">Transportation Management System (TMS)</h4>
                            <div className="mb-8 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
                                {tmsFeatures.map((feature, index) => (
                                    <div
                                        key={index}
                                        className={`group rounded-2xl bg-white p-6 text-center shadow-lg transition-all duration-1000 hover:shadow-xl dark:bg-gray-800 dark:shadow-black/40 dark:hover:shadow-xl delay-${
                                            (index + 1) * 100
                                        } ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}
                                    >
                                        <div
                                            className={`h-20 w-20 bg-gradient-to-r ${feature.color} mx-auto mb-4 flex items-center justify-center rounded-2xl shadow-lg transition-transform duration-300 group-hover:scale-110 dark:shadow-black/50`}
                                        >
                                            <div className="text-white">{feature.icon}</div>
                                        </div>
                                        <h5 className="text-lg font-semibold text-gray-900 dark:text-gray-100">{feature.title}</h5>
                                    </div>
                                ))}
                            </div>
                            {/* <div className="text-center">
                                <button className="rounded-full border border-gray-200 bg-gray-100 px-8 py-3 text-gray-900 shadow-sm transition-all hover:bg-gray-200 dark:border-gray-700 dark:bg-gray-700 dark:text-gray-100 dark:hover:bg-gray-600">
                                    Full Features List
                                </button>
                            </div> */}
                        </div>
                        ...
                        {/* Driver Features */}
                        <div>
                            <h4 className="mb-8 text-2xl font-bold text-blue-600 dark:text-blue-400">DeliveryCenter Driver</h4>
                            <div className="mb-8 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
                            ...
                            <div className="lg:w-1/2 lg:pl-12">
                                ...
                                <div className="mb-6 space-y-3">
                                    <div className="flex items-center">
                                        ...
                                        <span className="text-gray-700 dark:text-gray-300">Web-Based</span>
                                    </div>
                                    <div className="flex items-center">
                                        <Check className="mr-3 h-5 w-5 text-green-500" />
                                    ...
                                    <div className="flex items-center">
                                        <Check className="mr-3 h-5 w-5 text-green-500" />
                                        <span className="text-gray-700 dark:text-gray-300">Highly Customizable</span>
                                    </div>
                                </div>

                                <button
                                    onClick={() => router.visit('/demo')}
                                    className="transform cursor-pointer rounded-full bg-gradient-to-r from-blue-600 to-indigo-600 px-8 py-4 text-white shadow-lg transition-all hover:scale-105 hover:from-blue-700 hover:to-indigo-700"
                                >
                                    Get Started
                                </button>
                            </div>
